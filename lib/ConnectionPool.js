...
comb.define(comb.collections.Pool, {

    instance : {

        constructor : function(options) {
            options = options || {};
            if (!options.createConnection || !comb.isFunction(options.createConnection)) throw "patio.adapters.clients.ConnectionPool : create connection CB required.";
            if (!options.closeConnection || !comb.isFunction(options.closeConnection)) throw "patio.adapters.clients.ConnectionPool : close connection CB required.";
    ...
    static : {
        getPool : function(opts, createConnection, closeConnection, validateConnection) {
            return new this(comb.merge(opts, {
