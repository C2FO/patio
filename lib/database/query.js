            ...
            try {
                switch (type) {
                    ...
                    case  "decimal":
                        ...
                        break;
                    case "year" :
                        ret = this.moose.stringToYear(def);
                        break;
                    case "date":
                        ret = this.moose.stringToDate(def, datePattern);
                        break;
                    case "timestamp":
                        ret = this.moose.stringToTimeStamp(def, timeStampPattern);
                        break;
                    case "datetime":
                        ret = this.moose.stringToDateTime(def, dateTimePattern);
                        break;
                    case "time":
                        ret = this.moose.stringToTime(def, timePattern);
                        break;
                }
            } catch (e) {
            }
