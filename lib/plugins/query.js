...
var QueryPlugin = comb.define(null, {
    instance:{
        ...
        _saveReload:function (options) {
            ...
            return reload ? this.__reload() : new comb.Promise().callback(this);
        },
                ...
                if (!this.__isNew) {
                    return this._checkTransaction(options, hitch(this, function () {
                        ...
                        this._hook("pre", "update").then(hitch(this, function () {
                            (saveChange ? this._update(options) : new Promise().callback()).then(hitch(this, function () {
        ...
        _update:function (options) {
            ...
            this.dataset.filter(this._getPrimaryKeyQuery()).update(this.__changed)
                .chain(hitch(this, "_updateReload", options), ret)
            ...
            if (this.synced) {
                if (this.__isNew) {
                    return this._checkTransaction(options, hitch(this, function () {
                        ...
                        var ret = new comb.Promise();
                        this._hook("pre", "save")
                            .chain(hitch(this, "_save", options), ret)
                            .then(hitch(this, function () {
        ...
        _save:function (options) {
            ...
            var ret = new comb.Promise();
            this.dataset.insert(this._toObject()).then(hitch(this, function (id) {
                this.__ignore = true;
                if (id) {
                    this[pk] = id;
                }
                ...
                this._saveReload(options).then(hitch(this, function () {
