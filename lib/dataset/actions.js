...
define(null, {
    instance:{
        ...
        all:function (block, cb) {
            var a = [];
            var ret = asyncArray(this.forEach().chain(this.postLoad.bind(this)));
            if (block) {
                ...
                if (sliceSize) {
                    ...
                    var execute = function () {
                        ...
                        this.db.transaction(opts, hitch(this, function () {
                            return this.multiInsertSql(columns, values.slice(offset, sliceSize + offset)).forEach(hitch(this, function (st) {
