var comb = require("comb"), array = comb.array, ExpressionError = require("../errors").ExpressionError, Dataset, moose;
...
var Year = function (y) {
    this.date = comb.isDate(y) ? y : Date.apply(this, [y]);
};
...
var Time = function (y, m, d, h, min, s, ms) {
    this.date = comb.isDate(y) ? y : new Date(Date.apply(Date, arguments));
};
