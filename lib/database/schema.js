...
const generators = require("./schemaGenerators");
const SchemaGenerator = generators.SchemaGenerator;
const AlterTableGenerator = generators.AlterTableGenerator;
const sql = require("../sql").sql;
const Time = sql.Time;
const TimeStamp = sql.TimeStamp;
const DateTime = sql.DateTime;
const Year = sql.Year;
const Float = sql.Float;
const Decimal = sql.Decimal;
const Json = sql.Json;
