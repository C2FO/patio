...
var Json = define([OrderedMethods, ComplexExpressionMethods, BooleanMethods, NumericMethods, StringMethods, InequalityMethods, AliasMethods], {
    instance: {
        /**@lends patio.sql.JsonString*/

        /**
         * Represents a json string that should be placed into a SQL query literally.
         * @constructs
         * @augments patio.sql.OrderedMethods
         * @augments patio.sql.ComplexExpressionMethods
         * @augments patio.sql.BooleanMethods
...
STRING_METHODS.forEach(function (op) {
    Json.prototype[op] = addStringMethod(op);
}, this);
