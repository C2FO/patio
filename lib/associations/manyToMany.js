...
module.exports = exports = comb.define(OneToMany, {
    instance:{
        ...
        _filter:function(parent){
            ...
            return this._setDatasetOptions(this.model.dataset.naked().innerJoin(this.joinTableName, comb.array.zip(keys[1], this.modelPrimaryKey.map(function(k){
                ...
                if (!model.isNew) {
                    if (comb.isInstanceOf(item, this.model) && !item.isNew) {
                        ...
                        model._checkTransaction(comb.hitch(this, function(){
                            return comb.executeInOrder(item, this.joinTable, model, this, function(item, joinTable, model, self){
                                if (remove) {
                                    item.remove();
                                } else {
                        ...
                        })).then(comb.hitch(this, function(model){
                            if (loaded && reload) {
