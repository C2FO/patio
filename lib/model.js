...
exports.syncModels = function (cb) {
    var ret = new Promise();
    serial(MODELS.entrySet.map(function (entry) {
        return function () {
            var value = entry.value;
            return serial(value.entrySet.map(function (m) {
