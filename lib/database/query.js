...
const Queue = comb.collections.Queue;
...
const pipeAll = utils.pipeAll;
const resolveOrPromisfyFunction = utils.resolveOrPromisfyFunction;


const Database = define(null, {
    instance: {
