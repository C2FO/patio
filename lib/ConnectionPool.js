...
comb.define(comb.collections.Pool, {
    ...
    instance : {
        ...
        constructor : function(options) {
            options = options || {};
            if (!options.createConnection || !comb.isFunction(options.createConnection)) throw "moose.adapters.clients.ConnectionPool : create connection CB required.";
            if (!options.closeConnection || !comb.isFunction(options.closeConnection)) throw "moose.adapters.clients.ConnectionPool : close connection CB required.";
