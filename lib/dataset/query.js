...
comb.define(null, {
  ...
  static:{
    ...
    /**
     * These symbols have {name}Join methods created (e.g. {@link patio.Dataset#innerJoin}) that
     ...
     * call {@link patio.Dataset#joinTable} with the symbol.  They only accept a single table
     * argument which is passed to {@link patio.Dataset#joinTable}, and they raise an error
