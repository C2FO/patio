...
const DB = define(null, {
    ...
    "static": {
        ...
        connect: function (connectionString, opts) {
            ...
            if (isHash(connectionString) && connectionString.connectionString) {
                opts = connectionString;
                connectionString = opts.connectionString;
            }

            if (isString(connectionString)) {
                connectionString = connectionString ? connectionString : opts.connectionString;
