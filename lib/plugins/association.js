...
const oneToMany = associations.oneToMany;
const manyToOne = associations.manyToOne;
const oneToOne = associations.oneToOne;
const manyToMany = associations.manyToMany;
const fetch = associations.fetch;
const comb = require("comb");
const asyncArray = comb.async.array;
const Promise = comb.Promise;
const PromiseList = comb.PromiseList;

const RECIPROCAL_ASSOC = {
    "oneToOne": ["manyToOne"],
...
export const AssociationPlugin = comb.define(null, {
