...
comb.define([actions, graph, features, query, sql], {
    instance:{
         ...
         * <ul>
         *     <li>Join methods from {@link moose.Dataset.CONDITIONED_JOIN_TYPES} and
         *         {@link  moose.Dataset.UNCONDITIONED_JOIN_TYPES}, these methods handle the type call
         *         to {@link moose.dataset.Query#joinTable}, so to invoke include all arguments that
         *         {@link moose.dataset.Query#joinTable} requires except the type parameter. The default list includes.
         *         <ul>
         ...
         *     <h4>Features:</h4>
         *     <p>
         *           Features that a particular {@link moose.Dataset} supports are shown in the example below.
         ...
         *         been called upon it(with the exception of {@link moose.Dataset#graph} because columns
         ...
         *         <ul>
         *             <li>{@link moose.Dataset#all}</li>
         *             <li>{@link moose.Dataset#one}</li>
         *             <li>{@link moose.Dataset#avg}</li>
         *             <li>{@link moose.Dataset#count}</li>
         *             <li>{@link moose.Dataset#columns}</li>
         *             <li>{@link moose.Dataset#remove}</li>
         *             <li>{@link moose.Dataset#forEach}</li>
         *             <li>{@link moose.Dataset#empty}</li>
         *             <li>{@link moose.Dataset#first}</li>
         *             <li>{@link moose.Dataset#get}</li>
         *             <li>{@link moose.Dataset#import}</li>
         *             <li>{@link moose.Dataset#insert}</li>
         *             <li>{@link moose.Dataset#save}</li>
         *             <li>{@link moose.Dataset#insertMultiple}</li>
         *             <li>{@link moose.Dataset#saveMultiple}</li>
         *             <li>{@link moose.Dataset#interval}</li>
         *             <li>{@link moose.Dataset#last}</li>
         *             <li>{@link moose.Dataset#map}</li>
         *             <li>{@link moose.Dataset#max}</li>
         *             <li>{@link moose.Dataset#min}</li>
         *             <li>{@link moose.Dataset#multiInsert}</li>
         *             <li>{@link moose.Dataset#range}</li>
         *             <li>{@link moose.Dataset#selectHash}</li>
         *             <li>{@link moose.Dataset#selectMap}</li>
         *             <li>{@link moose.Dataset#selectOrderMap}</li>
         *             <li>{@link moose.Dataset#set}</li>
         *             <li>{@link moose.Dataset#singleRecord}</li>
         *             <li>{@link moose.Dataset#singleValue}</li>
         *             <li>{@link moose.Dataset#sum}</li>
         *             <li>{@link moose.Dataset#toCsv}</li>
         *             <li>{@link moose.Dataset#toHash}</li>
         *             <li>{@link moose.Dataset#truncate}</li>
         *             <li>{@link moose.Dataset#update}</li>
         *         </ul>
         *
         *     </p>
         * </p>
         ...
         *
         *
         * @param {moose.Database} db the database this dataset should use when querying for data.
         ...
         *                                     throws a {moose.errors.DatasetError} tf the dataset doesn't have a table.
         * <pre class="code">
         ...
         *                                      have a table, raises a {@link moose.erros.DatasetError}.
         *<pre class="code">
         *
         ...
         *
         * @property {comb.Promise} columns Returns a promise that is resolved with the columns in the result set in order as an array of strings.
         ...
         * If the options changed include options in {@moose.dataset.Query#COLUMN_CHANGE_OPTS}, the cached
         * columns are deleted.  This method should generally not be called
         * directly by user code.
         *
         * @param {Object} opts options to merge into the curred datasets options and applied to the returned dataset.
         * @return [moose.Dataset] a cloned dataset with the merged options
         **/
        ...
        /**
         * Converts a string to an {@link moose.sql.Identifier}, {@link moose.sql.QualifiedIdentifier},
         * or {@link moose.sql.AliasedExpression}, depending on the format:
         *
         * <ul>
         ...
         * @example
         *
         * ds.stringToIdentifier("a") //= > new moose.sql.Identifier("a");
         * ds.stringToIdentifier("table__column"); //=> new moose.sql.QualifiedIdentifier(table, column);
