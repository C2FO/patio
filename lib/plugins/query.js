...
var QueryPlugin = comb.define(null, {
    instance:{
        ...
        getUpdateSql:function () {
            return this.dataset.filter(this._getPrimaryKeyQuery()).updateSql(this.__changed);
        },


        getInsertSql:function () {
            return this.dataset.insertSql(this._toObject());
        },

        getRemoveSql:function () {
            return this.dataset.filter(this._getPrimaryKeyQuery()).deleteSql;
        },
