...
var Database = define(null, {
    instance:{
                ...
                connPromise.then(hitch(this, function (conn) {
                    this.__beginTransaction(conn, opts).then(hitch(this, function () {
                        this.__transactionProxy(cb, conn).then(hitch(this, function (res) {
                            this.__commitTransaction(conn).then(hitch(this, "__transactionComplete", promise, "callback", conn), hitch(this, "__transactionComplete", promise, "errback", conn));
        ...
        __beginNewTransaction:function (conn, opts) {
            var ret = new Promise();
            this.__logConnectionExecute(conn, this.beginTransactionSql).chain(hitch(this, "__setTransactionIsolation", conn, opts), ret).then(ret);
            return ret.promise();
        },
