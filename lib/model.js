...
var addSetter = function(name, setterFunc){
    return function(val){
        var ignore = this.__ignore, col = this.schema[name];
        ...
        static:{
            ...
            _setColumns:function(cols){
                ...
                cols.forEach(function(name){
                    proto.__defineGetter__(name, addGetter(name));
                    proto.__defineSetter__(name, addSetter(name));
                }, this);
            },
