    ...
    instance:{
        ...
        fetchRows:function (sql) {
            return asyncArray(this.execute(sql).chain(function (r, fields) {
                ...
                return this.__processRows(r, cols);
            }.bind(this)));
        },
        ...
        __processRows:function (rows, cols) {
            ...
            return comb(rows).map(function (row) {
                var h = {};
    ...
    instance:{
        ...
        __beginNewTransaction:function (conn, opts) {
            return this.__setTransactionIsolation(conn, opts)
                .chain(comb("__logConnectionExecute").bindIgnore(this, conn, this.beginTransactionSql));
        },
        ...
        __commitTransaction:function (conn, opts) {
            ...
            var s = opts.prepare;
            if (s) {
                return this.__logConnectionExecute(conn, comb("XA END %s").format(this.literal(s)))
                    .chain(comb("__logConnectionExecute").bindIgnore(this, comb("XA PREPARE %s").format(this.literal(s))))
            } else {
                return this._super(arguments);
            }
        },
        ...
        __rollbackTransaction:function (conn, opts) {
            ...
            if (s) {
                ...
                return this.__logConnectionExecute(conn, "XA END " + s)
                    .chain(logConnectionExecute.bindIngore(this, conn, "XA PREPARE " + s))
                    .chain(logConnectionExecute.bindIngore(this, conn, "XA ROLLBACK " + s))
            } else {
                return this._super(arguments);
            }
        },
