...
var IntegerMigrator = comb.define(Migrator, {
    instance:{
        ...
        run:function () {
            ...
            comb.serial([this._getLatestMigrationVersion.bind(this), this._getCurrentMigrationVersion.bind(this)]).then(hitch(this, function (res) {
...
var TimestampMigrator = comb.define(Migrator, {
    instance:{
        ...
        run:function () {
            ...
            comb.serial([this.__getMirationFiles.bind(this), this._getSchemaDataset.bind(this)]).then(function (res) {
