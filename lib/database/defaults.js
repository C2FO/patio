...
comb.define(null, {
  instance:{
    ...
    constructor:function(opts) {
      ...
      var static = this._static;
      this.__identifierInputMethod = comb.isUndefined(opts.identifierInputMethod) ? comb.isUndefined(static.identifierInputMethod) ? this.identifierInputMethodDefault : static.identifierInputMethod : opts.identifierInputMethod;
      this.__identifierOutputMethod = comb.isUndefined(opts.identifierOutputMethod) ? comb.isUndefined(static.identifierOutputMethod) ? this.identifierOutputMethodDefault : static.identifierOutputMethod : opts.identifierOutputMethod;
