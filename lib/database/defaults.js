...
comb.define(null, {
  instance:{
    ...
    constructor:function(opts) {
      ...
      this.__identifierInputMethod = comb.isUndefined(opts.identifierInputMethod) ? comb.isUndefined(statics.identifierInputMethod) ? this.identifierInputMethodDefault : statics.identifierInputMethod : opts.identifierInputMethod;
      this.__identifierOutputMethod = comb.isUndefined(opts.identifierOutputMethod) ? comb.isUndefined(statics.identifierOutputMethod) ? this.identifierOutputMethodDefault : statics.identifierOutputMethod : opts.identifierOutputMethod;
      this.__quoteIdentifiers = comb.isUndefined(opts.quoteIdentifiers) ? comb.isUndefinedOrNull(statics.quoteIdentifiers) ? this.quoteIdentifiersDefault : statics.quoteIdentifiers : opts.quoteIdentifiers;
    },
