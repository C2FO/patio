...
const DatasetDB = require("./dataset");
const DefaultsDB = require("./defaults");
const LoggingDB = require("./logging");
const QueryDB = require("./query");
const SchemaDB = require("./schema");
let patio;

const DATABASES = [];
const Database = define([ConnectDB, DatasetDB, DefaultsDB, LoggingDB, QueryDB, SchemaDB], {
