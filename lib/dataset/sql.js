...
const intersect = array.intersect;
const compact = array.compact;
const string = comb.string;
...
const Json = sql.Json;
const JsonArray = sql.JsonArray;
const Expression = sql.Expression;
const ComplexExpression = sql.ComplexExpression;
const AliasedExpression = sql.AliasedExpression;
const Identifier = sql.Identifier;
const QualifiedIdentifier = sql.QualifiedIdentifier;
const OrderedExpression = sql.OrderedExpression;
const CaseExpression = sql.CaseExpression;
const SubScript = sql.SubScript;
const NumericExpression = sql.NumericExpression;
const ColumnAll = sql.ColumnAll;
const Cast = sql.Cast;
const StringExpression = sql.StringExpression;
const BooleanExpression = sql.BooleanExpression;
const SQLFunction = sql.SQLFunction;
const LiteralString = sql.LiteralString;
const PlaceHolderLiteralString = sql.PlaceHolderLiteralString;
const QueryError = require("../errors").QueryError

let patio, Dataset;

const clauseMethods = function (type, clauses) {
    if (isString(clauses)) {
