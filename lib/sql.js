 ...
 * See {@link mooseTime#yearToString} for formatting information.
 *
 * @example
 *
 * var year = moose.Year(2009); //=> 2009
 ...
 * See {@link mooseTime#timeToString} for formatting information.
 *
 * @example
 *
 * var time = moose.Time(12, 12, 12); //=> 12:12:12
 ...
 * See {@link mooseTime#timeStampToString} for formatting information.
 *
 * @example
 *
 * var timeStamp = moose.TimeStamp(2009, 10, 10, 10, 10, 10); //=> '2009-11-10 10:10:10'
 ...
 * See {@link mooseTime#dateTimeToString} for formatting information.
 *
 * @example
 *
 * var dateTime = moose.DateTime(2009, 10, 10, 10, 10, 10); //=> '2009-11-10 10:10:10'
 ...
 *
 * <p>
 *  The {@link moose.sql} object
 *  can be used directly to create {@link moose.sql.Expression}s, {@link moose.sql.Identifier}s, {@link moose.sql.SQLFunction}s,
 *  and {@link moose.sql.QualifiedIdentifier}s.
 * <pre class='code'>
 *  var sql = moose.sql;
...
var sql = {
    ...
    /**
     * Returns a {@link moose.sql.Identifier}, {@link moose.sql.QualifiedIdentifier},
     * or {@link moose.sql.ALiasedExpression} depending on the format of the string
     * passed in.
     *
     * <ul>
     ...
     *      //=> new moose.sql.AliasedExpression(new moose.sql.QualifiedIdentifier(table, column), alias);
     *
     * @param {String} name the name to covert to an an {@link moose.sql.Identifier}, {@link moose.sql.QualifiedIdentifier},
     * or {@link moose.sql.AliasedExpression}.
     *
     * @return  {moose.sql.Identifier|moose.sql.QualifiedIdentifier|moose.sql.AliasedExpression} an identifier generated based on the name string.
     */
    ...
    /**
     * Creates a {@link moose.sql.LiteralString} or {@link moose.sql.PlaceHolderLiteralString}
     * depending on the arguments passed in. If a single string is passed in then
     * it is assumed to be a {@link moose.sql.LiteralString}. If more than one argument is
     * passed in then it is assumed to be a {@link moose.sql.PlaceHolderLiteralString}.
     *
     * @example
     *
     ...
     * moose.sql.literal("a = {a} AND b = {b}", {a : 1, b : 2}); //=> a = 1 AND b = 2
     *
     * @param {String ...} s variable number of arguments where the first argument
     * is a string. If multiple arguments are passed it is a assumed to be a {@link moose.sql.PlaceHolderLiteralString}
     *
     * @return {moose.sql.LiteralString|moose.sql.PlaceHolderLiteralString} an expression that can be used as an argument
     * for {@link moose.Dataset} query methods.
     */
    literal:function (s) {
        var args = comb.argsToArray(arguments);
    ...
    /**
     * Returns a {@link moose.sql.CaseExpression}. See {@link moose.sql.CaseExpression} for argument types.
     *
     * @example
     *
    ...
    /**
     * Creates a {@link moose.sql.StringExpression}
     *
     * Return a {@link moose.sql.StringExpression} representing an SQL string made up of the
     * concatenation of this array's elements.  If an joiner is passed
     * it is used in between each element of the array in the SQL
     * concatenation.
     *
     * @example
     *   moose.sql.sqlStringJoin(["a"]); //=> a
     ...
     *   moose.sql.sqlStringJoin(['a', sql.b], ' '); //=> 'a' || ' ' || b
     */
...
var AliasMethods = comb.define(null, {
    instance:{
        /**@lends moose.sql.AliasMethods.prototype*/

        /**
         *  Create an SQL alias {@link moose.sql.AliasedExpression} of the receiving column or expression
         *  to the given alias.
         *
         * @example
         *
         ...
         *
         * @return {moose.sql.AliasedExpression} the aliased expression.
         */
        as:function (alias) {
 ...
 * methods are only on {@link moose.sql.NumericExpression}
 *
 * @example
...
var BitWiseMethods = comb.define(null, {
    instance:{
        /**@lends moose.sql.BitWiseMethods.prototype*/
 ...
 * ({@link moose.sql.LiteralString}, and {@link moose.sql.GenericExpression}).
 *
 * @example
...
var BooleanMethods = comb.define(null, {
    instance:{
        /**@lends moose.sql.BooleanMethods.prototype*/
         ...
         * sql.a.and(sql.b) //=> "a" AND "b"
         *
         * @return {moose.sql.BooleanExpression} a ANDed boolean expression.
         */
         ...
         * sql.a.or(sql.b) //=> "a" OR "b"
         *
         * @return {moose.sql.BooleanExpression} a ORed boolean expression
         */
        or:booleanMethod("or"),
         ...
         * sql.a.not() //=> NOT "a"
         *
         * @return {moose.sql.BooleanExpression} a inverted boolean expression.
         */
        not:function () {
...
var CastMethods = comb.define(null, {
    instance:{
        /**@lends moose.sql.CastMethods.prototype*/
        /**
         ...
         *
         * @return {moose.sql.Cast} the casted expression
         */
        cast:function (type) {
         ...
         *
         * @return {moose.sql.NumericExpression} a casted numberic expression
         */
         ...
         * and return the result as a {@link moose.sql.StringExpression}.
         *
         * @example
         *
         ...
         *
         * @return {moose.sql.StringExpression} the casted string expression
         */
 ...
 * @memberOf moose.sql
 * @property {moose.sql.BooleanExpression} sqlBoolean Return a {@link moose.sql.BooleanExpression} representation of this expression type.
 * @property {moose.sql.BooleanExpression} sqlFunction Return a {@link moose.sql.SQLFunction} representation of this expression type.
 * @property {moose.sql.BooleanExpression} sqlNumber Return a {@link moose.sql.NumericExpression} representation of this expression type.
 * <pre class="code">
 * sql.a.not("a") //=> NOT "a"
 * sql.a.sqlNumber.not() //=> ~"a"
 * </pre>
 * @property {moose.sql.BooleanExpression} sqlString  Return a {@link moose.sql.StringExpression} representation of this expression type.
 * <pre class="code">
...
var InequalityMethods = comb.define(null, {
    instance:{
        /**@lends moose.sql.InequalityMethods.prototype*/

        /**
         * @function Creates a gt {@link moose.sql.BooleanExpression} compared to this expression.
         * @example
         *
         * sql.a.gt("b")  //=> a > "b"
         *
         * @return {moose.sql.BooleanExpression}
         */
        gt:inequalityMethod("gt"),
        /**
         * @function Creates a gte {@link moose.sql.BooleanExpression} compared to this expression.
         *
         * @example
         *
         * sql.a.gte("b")  //=> a >= "b"
        ...
        /**
         * @function Creates a lt {@link moose.sql.BooleanExpression} compared to this expression.
         *
         * @example
         *
         * sql.a.lt("b")  //=> a < "b"
        ...
        /**
         * @function  Creates a lte {@link moose.sql.BooleanExpression} compared to this expression.
         *
         * @example
         *
         * sql.a.lte("b")  //=> a <= "b"
        ...
        /**
         * @function  Creates a eq {@link moose.sql.BooleanExpression} compared to this expression.
         *
         * @example
         *
         * sql.a.eq("b")  //=> a = "b"
...
/**
 * @class This mixin augments the default constructor for {@link moose.sql.ComplexExpression},
 * so that attempting to use boolean input when initializing a {@link moose.sql.NumericExpression}
 * or {@link moose.sql.StringExpression} results in an error. <b>It is not expected to be used directly.</b>
 *
...
var numericMethod = function (op) {
    return function (expression) {
        if (comb.isInstanceOf(expression, BooleanExpression, StringExpression)) {
            throw new ExpressionError("Cannot apply " + op + " to a non numeric expression");
        } else {
...
var NumericMethods = comb.define(null, {
    instance:{
        /**@lends moose.sql.NumericMethods.prototype*/


        /**
         * @function  Adds the provided expression to this expression and returns a {@link moose.sql.NumericExpression}.
         *
         * @example
         *
         * sql.a.plus(sql.b)  //=> "a" + "b"
         *
         * @return {moose.sql.NumericExpression}
         */
        plus:numericMethod("plus"),

        /**
         * @function  Subtracts the provided expression from this expression and returns a {@link moose.sql.NumericExpression}.
         *
         * @example
         *
         * sql.a.minus(sql.b)  //=> "a" - "b"
        ...
        /**
         * @function  Divides this expression by the  provided expression and returns a {@link moose.sql.NumericExpression}.
         *
         * @example
         *
         * sql.a.divide(sql.b)  //=> "a" / "b"
...
var OrderedMethods = comb.define(null, {
    instance:{
        /**@lends moose.sql.OrderedMethods.prototype*/
         ...
         * @return {moose.sql.OrderedExpression}
         */
...
var QualifyingMethods = comb.define(null, {
    instance:{
        /**@lends moose.sql.QualifyingMethods.prototype*/
         ...
         * sql.column.qualify("table").qualify("schema") //=> "schema"."table"."column"
         *
         * @param {String|moose.sql.Identifier} qualifier table/schema to qualify this expression to.
         *
         * @return {moose.sql.QualifiedIdentifier}
         */
...
var StringMethods = comb.define(null, {
    instance:{
        /**@lends moose.sql.StringMethods.prototype*/

        /**
         * Create a {@link moose.sql.BooleanExpression} case insensitive pattern match of the receiver
         * with the given patterns.  See {@link moose.sql.StringExpression#like}.
         *
         * @example
         * sql.a.iLike("A%"); //=> "a" LIKE 'A%'
         *
        ...
        /**
         * Create a {@link moose.sql.BooleanExpression} case sensitive (if the database supports it) pattern match of the receiver with
         * the given patterns.  See {@link moose.sql.StringExpression#like}.
         *
         * @example
         * sql.a.like(/^a/); //=>  "a" ~* '^a'
         * sql.a.like("A%"); //=> "a" LIKE 'A%'
...
var StringConcatenationMethods = comb.define(null, {
    instance:{
        /**@lends moose.sql.StringConcatenationMethods.prototype*/

        /**
         * Return a {@link moose.sql.StringExpression} representing the concatenation of this expression
...
var SubscriptMethods = comb.define(null, {
    instance:{
        ...
        /**
         * Return a {@link moose.sql.Subscript} with the given arguments, representing an
         * SQL array access.
         *
         * @example
         * sql.array.sqlSubscript(1) //=> array[1]
...
var Expression = comb.define(null, {
    ...
    instance:{
        /**@lends moose.sql.Expression.prototype*/

        /**
         * Returns the string representation of this expression
         *
         * @param {moose.Dataset} ds the dataset that will be used to SQL-ify this expression.
    ...
    static:{
         ...
         *
         * @return {moose.sql.Expression} an expression.
         */
 ...
 *
 * @augments moose.sql.Expression
 * @augments moose.sql.AliasMethods
 * @augments moose.sql.BooleanMethods
 * @augments moose.sql.CastMethods
 * @augments moose.sql.ComplexExpressionMethods
 * @augments moose.sql.InequalityMethods
 * @augments moose.sql.NumericMethods
 * @augments moose.sql.OrderedMethods
 * @augments moose.sql.StringMethods
 * @augments moose.sql.SubscriptMethods
 *
...
var AliasedExpression = comb.define(Expression, {
        instance:{
            /**@lends moose.sql.AliasedExpression.prototype*/
             ...
             * @param {moose.Dataset} [ds] dataset used to created the SQL fragment, if
             * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
             *
...
var CaseExpression = comb.define(GenericExpression, {
    instance:{
        /**@lends moose.sql.CaseExpression.prototype*/
         ...
         *
         * @constructs
         * @augments moose.sql.GenericExpression
         ...
         * @property conditions the conditions of the {@link moose.sql.CaseExpression}.
         * @property def the default value of the {@link moose.sql.CaseExpression}.
         * @property expression the expression of the {@link moose.sql.CaseExpression}.
         * @property {Boolean} noExpression true if this {@link moose.sql.CaseExpression}'s expression is undefined.
         */
...
var ColumnAll = comb.define(Expression, {
    instance:{
        /**@lends moose.sql.ColumnAll.prototype*/
...
var ComplexExpression = comb.define([Expression, AliasMethods, CastMethods, OrderedMethods, SubscriptMethods], {
    instance:{
        /**@lends moose.sql.ComplexExpression.prototype*/
         ...
         * subclasses @link moose.sql.BooleanExpression},
         * {@link moose.sql.NumericExpression} and {@link moose.sql.StringExpression} should
         ...
         * @augments moose.sql.SubscriptMethods
         *
         * @throws {moose.sql.ExpressionError} if the operator doesn't allow boolean input and a boolean argument is given.
         * @throws {moose.sql.ExpressionError} if the wrong number of arguments for a given operator is used.
         *
         * @param {...} op The operator and arguments for this object to the ones given.
         * <p>
         *     Convert all args that are hashes or arrays of two element arrays to {@link moose.sql.BooleanExpression}s,
         ...
         * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
         *
         * @return String the SQL version of the {@link moose.sql.ComplexExpression}.
         */
        toString:function (ds) {
            ds = ds || new Dataset();
    ...
    static:{
        /**@lends moose.sql.ComplexExpression*/
...
/**
 * @class Subclass of {@link moose.sql.ComplexExpression} where the expression results
 * in a boolean value in SQL.
 *
 * @augments moose.sql.ComplexExpression
 * @augments moose.sql.BooleanMethods
...
var BooleanExpression = comb.define([ComplexExpression, BooleanMethods], {
    static:{
        /**@lends moose.sql.BooleanExpression*/

        /**
         * Invert the expression, if possible.  If the expression cannot
         * be inverted, it throws an {@link moose.error.ExpressionError}.  An inverted expression should match
         ...
         *
         * @param {moose.sql.BooleanExpression} expression
         * the expression to invert.
         *
         * @return {moose.sql.BooleanExpression} the inverted expression.
         */
         ...
         * and converts it to a {@link moose.sql.BooleanExpression}.  The operator and args
         ...
         * </pre>
         * @param {Object} a object to convert to a {@link moose.sql.BooleanExpression}
         * @param {String} [op="AND"] Boolean operator to join each subexpression with.
         * <pre class="code">
         *     BooleanExpression.fromValuePairs({a : [1,2,3], b : true}, "OR") //=> a IN (1,2,3) OR b IS TRUE
         * </pre>
         * @param {Boolean} [negate=false] set to try to invert the {@link moose.sql.BooleanExpression}.
         * <pre class="code">
         * BooleanExpression.fromValuePairs({a : [1,2,3], b : true}, "OR", true) //=> a NOT IN (1,2,3) AND b IS NOT TRUE
         * </pre>
         * @return {moose.sql.BooleanExpression} expression composed of sub expressions built from the hash.
         */
...
var Constant = comb.define(GenericExpression, {
    instance:{
        /**@lends moose.sql.Constant.prototype*/
        /**
        ...
        /**
         * Converts the {@link moose.sql.Constant} to a string.
         *
         * @param {moose.Dataset} [ds] dataset used to created the SQL fragment, if
         * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
         *
         * @return String the SQL version of the {@link moose.sql.Constant}.
         */
        toString:function (ds) {
            ds = ds || new Dataset();
 ...
 * @auments moose.sql.Constant
 * @name BooleanConstant
 * @memberOf moose.sql
 */
var BooleanConstant = comb.define(Constant, {
    instance:{
        /**@lends moose.sql.BooleanConstant.prototype*/

        /**
         * Converts the {@link moose.sql.BooleanConstant} to a string.
         *
         * @param {moose.Dataset} [ds] dataset used to created the SQL fragment, if
         * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
         *
         * @return String the SQL version of the {@link moose.sql.BooleanConstant}.
         */
        toString:function (ds) {
            ds = ds || new Dataset();
 ...
 *
 * @augments moose.sql.BooleanConstant
 * @name NegativeBooleanConstant
 * @memberOf moose.sql
 */
var NegativeBooleanConstant = comb.define(BooleanConstant, {
    instance:{
        /**@lends moose.sql.NegativeBooleanConstant.prototype*/

        /**
         * Converts the {@link moose.sql.NegativeBooleanConstant} to a string.
         *
         * @param {moose.Dataset} [ds] dataset used to created the SQL fragment, if
         * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
         *
         * @return String the SQL version of the {@link moose.sql.NegativeBooleanConstant}.
         */
        toString:function (ds) {
            ds = ds || new Dataset();
 ...
 * are included in {@link moose}
 * @name Constants
 * @memberOf moose.sql
 */
sql.Constants = {
    /**@lends moose.sql.Constants*/

    /**
     * Constant for CURRENT DATE
     * @type moose.sql.Constant
     */
    ...
    /**
     * Constant for TRUE
     * @type moose.sql.BooleanConstant
     */
     ...
     * @type moose.sql.NegativeBooleanConstant
     */
...
var Identifier = comb.define([GenericExpression, QualifyingMethods], {
    instance:{
        /**@lends moose.sql.Identifier.prototype*/
         ...
         * @constructs
         * @augments moose.sql.GenericExpression
         * @augments moose.sql.QualifyingMethods
         *
        ...
        /**
         * Converts the {@link moose.sql.Identifier} to a string.
         *
         * @param {moose.Dataset} [ds] dataset used to created the SQL fragment, if
         * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
         *
         * @return String the SQL version of the {@link moose.sql.Identifier}.
         */
        toString:function (ds) {
            ds = ds || new Dataset();
...
var JoinClause = comb.define(Expression, {
    instance:{
        /**@lends moose.sql.JoinClause.prototype*/

        /**
         * Represents an SQL JOIN clause, used for joining tables.
         * Created by {@link moose.Dataset} join methods.
         * @constructs
         * @augments moose.sql.Expression
         *
        ...
        /**
         * Converts the {@link moose.sql.JoinClause} to a string.
         *
         * @param {moose.Dataset} [ds] dataset used to created the SQL fragment, if
         * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
         *
         * @return String the SQL version of the {@link moose.sql.JoinClause}.
         */
        toString:function (ds) {
            ds = ds || new Dataset();
...
var JoinOnClause = comb.define(JoinClause, {
    instance:{
        /**@lends moose.sql.JoinOnClause.prototype*/
        /**
         * Represents an SQL JOIN clause with ON conditions. Created by {@link moose.Dataset} join methods.
         * See {@link moose.sql.JoinClause} for other argument parameters.
         * @constructs
         * @augments moose.sql.JoinClause
         *
         * @param on the expression to filter with. See {@link moose.Dataset#filter}
        ...
        /**
         * Converts the {@link moose.sql.JoinOnClause} to a string.
         *
         * @param {moose.Dataset} [ds] dataset used to created the SQL fragment, if
         * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
         *
         * @return String the SQL version of the {@link moose.sql.JoinOnClause}.
         */
        toString:function (ds) {
            ds = ds || new Dataset();
...
var JoinUsingClause = comb.define(JoinClause, {
    instance:{
        /**@lends moose.sql.JoinUsingClause.prototype*/
        ...
        /**
         * Converts the {@link moose.sql.JoinUsingClause} to a string.
         *
         * @param {moose.Dataset} [ds] dataset used to created the SQL fragment, if
         * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
         *
         * @return String the SQL version of the {@link moose.sql.JoinUsingClause}.
         */
        toString:function (ds) {
            ds = ds || new Dataset();
...
var PlaceHolderLiteralString = comb.define(GenericExpression, {
    instance:{
        /**@lends moose.sql.PlaceHolderLiteralString.prototype*/
         ...
         * @param {Array} args array of arguments that will be literalized using {@link moose.Dataset#literal}, and
         ...
         * @property {Array} args <b>READ ONLY</b> array of arguments that will be literalized using {@link moose.Dataset#literal}, and
         * replaced in the string.
        ...
        /**
         * Converts the {@link moose.sql.PlaceHolderLiteralString} to a string.
         *
         * @param {moose.Dataset} [ds] dataset used to created the SQL fragment, if
         * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
         *
         * @return String the SQL version of the {@link moose.sql.PlaceHolderLiteralString}.
         */
        toString:function (ds) {
            ds = ds || new Dataset();
...
var SQLFunction = comb.define(GenericExpression, {
    instance:{
         ...
         * {@link moose.Dataset#literal} and placed into the SQL function call.
         *
        ...
        /**
         * Converts the {@link moose.sql.SQLFunction} to a string.
         *
         * @param {moose.Dataset} [ds] dataset used to created the SQL fragment, if
         * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
         *
         * @return String the SQL version of the {@link moose.sql.SQLFunction}.
         */
        toString:function (ds) {
            ds = ds || new Dataset();
 ...
 *
 * @augments moose.sql.ComplexExpression
 * @augments moose.sql.BitWiseMethods
 * @augments moose.sql.NumericMethods
 * @augments moose.sql.InequalityMethods
 */
...
var OrderedExpression = comb.define(Expression, {
    instance:{
        /**@lends moose.sql.OrderedExpression.prototype*/
        ...
        /**
         * @return {moose.sql.OrderedExpression} a copy that is ordered ASC
         */
        asc:function () {
        ...
        /**
         * @return {moose.sql.OrderedExpression} Return a copy that is ordered DESC
         */
        desc:function () {
        ...
        /**
         * * @return {moose.sql.OrderedExpression} an inverted expression, changing ASC to DESC and NULLS FIRST to NULLS LAST.
         * */
        invert:function () {
        ...
        /**
         * Converts the {@link moose.sql.OrderedExpression} to a string.
         *
         * @param {moose.Dataset} [ds] dataset used to created the SQL fragment, if
         * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
         *
         * @return String the SQL version of the {@link moose.sql.OrderedExpression}.
         */
        toString:function (ds) {
            ds = ds || new Dataset();
    ...
    static:{
        /**@lends moose.sql.OrderedExpression*/
        /**
...
var QualifiedIdentifier = comb.define([GenericExpression, QualifyingMethods], {
    instance:{
        /**@lends moose.sql.QualifiedIdentifier.prototype*/
        ...
        /**
         * Converts the {@link moose.sql.QualifiedIdentifier} to a string.
         *
         * @param {moose.Dataset} [ds] dataset used to created the SQL fragment, if
         * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
         *
         * @return String the SQL version of the {@link moose.sql.QualifiedIdentifier}.
         */
        toString:function (ds) {
            ds = ds || new Dataset();
 ...
 * @augments moose.sql.ComplexExpression
 * @augments moose.sql.StringMethods
 * @augments moose.sql.StringConcatenationMethods
 * @augments moose.sql.InequalityMethods
 * @augments moose.sql.NoBooleanInputMethods
...
var StringExpression = comb.define([ComplexExpression, StringMethods, StringConcatenationMethods, InequalityMethods, NoBooleanInputMethods], {
    static:{
        /**@lends moose.sql.StringExpression*/
         ...
         * advanced regular expression features.  Moose just uses the source of the
        ...
        /**
         * Like map used to by {@link moose.sql.StringExpression.like} to create the
         * LIKE expression.
         * @type Object
         */
...
var SubScript = comb.define(GenericExpression, {
    instance:{
        /**@lends moose.sql.SubScript.prototype*/
        ...
        /**
         * Create a new {@link moose.sql.Subscript} appending the given subscript(s)
        ...
        /**
         * Converts the {@link moose.sql.SubScript} to a string.
         *
         * @param {moose.Dataset} [ds] dataset used to created the SQL fragment, if
         * the dataset is ommited then the default {@link moose.Dataset} implementation is used.
         *
         * @return String the SQL version of the {@link moose.sql.SubScript}.
         */
        toString:function (ds) {
            ds = ds || new Dataset();
