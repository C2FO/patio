...
var DS = comb.define(Dataset, {
    ...
    instance : {
        ...
        distinct : function(args) {
            ...
            return args.length == 0 ? this.super(arguments) : this.group.apply(this, args);
        },
        ...
        fullTextSearch : function(cols, terms, opts) {
            opts = opts || {};
            cols = cols.map(this.stringToIdentifier, this);
        ...
        joinTable : function(type, table, expr, tableAlias) {
            ...
            return this.super(arguments, [type,table,expr,tableAlias]);
        },
        ...
        onDuplicateKeyUpdate : function(args) {
            ...
            if (args.length) {
                ...
                throw new QueryError("Columns required for onDuplicateKeyUpdate.");
            }
        },
        ...
        _insertSql : function() {
            return this.__opts.replace ? this.clauseSql("replace") : this.super(arguments);
        },

        //Consider the first table in the joined dataset is the table to delete
        //from, but include the others for the purposes of selecting rows.
        deleteFromSql : function(sql) {
            if (this.joinedDataset()) {
                return format(" %s FROM %s", this.sourceList(this.__opts.from[0]), this.sourceList(this.__opts.from)) + this.selectJoinSql();
            } else {
                return this.super(arguments);
            }
        },
        ...
        insertIgnoreSql : function(sql) {
            return this.__opts.insertIgnore ? " IGNORE" : "";
        },

        //MySQL supports INSERT ... ON DUPLICATE KEY UPDATE
        insertOnDuplicateKeyUpdateSql : function(sql) {
        ...
        deleteLimitSql : function() {
            return this.limitSql.apply(this, arguments);
        },

        updateLimitSql : function() {
            return this.limitSql.apply(this, arguments);
        },
        ...
        onDuplicateKeyUpdateSql : function() {
            ...
            if (updateCols) {
                ...
                if ((l = updateCols.length) > 0 && comb.isHash((last = updateCols[l - 1]))) {
                    updateVals = last;
                    updateCols = updateCols.slice(0, l - 2);
                }
                var updating = updateCols.map(function(c) {
                    var quoted = this.quoteIdentifier(c);
                    return format("%s=%s", quoted, quoted);
                }, this);
                for (var i in updateVals) {
                    updating.push(format("%s = %s", this.quoteIdentifier(i), this.literal(updateVals[1])));
                }
                updateVals && (ret = format(" ON DUPLICATE KEY UPDATE %s", updating.join(this.static.COMMA_SEPARATOR)));
            }
            return ret;
        },
        ...
        selectLockSql : function(sql) {
            return this.__opts.lock == "share" ? this.static.FOR_SHARE : this.super(arguments);
        },
        ...
        replace : function() {
            this.executeDui(this.replaceSql.apply(this, arguments), function(c, info) {
                return c.insertId
            });
        },
        ...
        update : function() {
            this.executeDui(this.updateSql.apply(this, arguments), function(c, info) {
                return c.affectedRows;
            });
        },
        ...
        execute : function(sql, opts, block) {
            ...
            return this.super(arguments, [sql, comb.merge({type : "select"}, opts), block]);
        },
        ...
        executeDui : function(sql, opts, block) {
            ...
            return this.super(arguments, [sql, comb.merge({type : "dui"}, opts), block]);
        },
    ...
    static : {
        ...
        DELETE_CLAUSE_METHODS : ["deleteFromSql", "deleteWhereSql", "deleteOrderSql", "deleteLimitSql"],
        INSERT_CLAUSE_METHODS : ["insertIgnoreSql", "insertIntoSql", "insertColumnsSql", "insertValuesSql", "insertOnDuplicateKeyUpdateSql"],
        REPLACE_CLAUSE_METHODS : ["insertIgnoreSql", "insertIntoSql", "insertColumnsSql", "insertValuesSql", "insertOnDuplicateKeyUpdateSql"],
        SELECT_CLAUSE_METHODS : ["selectDistinctSql", "selectColumnsSql", "selectFromSql", "selectJoinSql", "selectWhereSql", "selectGroupSql", "selectHavingSql", "selectCompoundsSql", "selectOrderSql", "selectLimitSql", "selectLockSql"],
        UPDATE_CLAUSE_METHODS : ["updateTableSql", "updateSetSql", "updateWhereSql", "updateOrderSql", "updateLimitSql"]
...
var DB = comb.define(Database, {
    instance : {
        ...
        __execute : function(conn, sql, opts, cb) {
            ...
            this.__logAndExecute(sql,
                ...
                try {
                    if (type == "select") {
                        ret.callback(r ? cb(r, info) : null);
                    } else if (cb) {
                        ret.callback(cb(r, info));
                    } else {
                        ret.callback();
                    }
                } finally {
        ...
        castTypeLiteral : function(type) {
            return  this.static.CAST_TYPES[type] || this.super(arguments);
        },
        ...
        indexes : function(table, opts) {
            ...
            var ret = new comb.Promise();
            this.metadataDataset.withSql("SHOW INDEX FROM ?", new sql.Identifier(im(table))).forEach(
                function(r) {
                    var name = r.Key_name;
                    if (name != "PRIMARY") {
                        name = m(name);
        ...
        use : function(dbName) {
            var ret = new comb.Promise();
            this.disconnect().then(htich(this, function() {
        ...
        __alterTableSql : function(table, op) {
            ...
            if (op.op == "addColumn") {
                ...
                if (related) {
                    delete op.table;
                    this.super(arguments).then(hitch(this, function(sql) {
                        op.table = related;
                ...
                this.schema(table).then(hitch(this, function(schema) {
                    ...
                    opts.null = op.null || opts.allowNull;
        ...
        beginNewTransaction : function(conn, opts) {
            var ret = new comb.Promise();
            this.__setTransactionIsolation(conn, opts)
                .then(hitch(this, this.__logConnectionExecute, conn, this.beginTransactionSql), hitch(ret, "errback"))
        ...
        //option is given.
        beginTransaction : function(conn, opts) {
            opts = opts || {};
            var s;
            if (s = opts.prepare) {
        ...
        __columnDefinitionSql : function(column) {
            if (column.type.match(/string/i) && column.text == true) {
                delete column["default"];
            }
            return this.super(arguments, [column]);
        },
        ...
        __createTableSql : function(name, generator, options) {
            ...
            comb.isUndefined(engine) && (engine = this.static.defaultEngine);
            comb.isUndefined(charset) && (charset = this.static.defaultCharset);
            comb.isUndefined(collate) && (collate = this.static.defaultCollate);
            ...
            return format(" %s%s%s%s", this.super(arguments), engine ? " ENGINE=" + engine : "", charset ? " DEFAULT CHARSET=" + charset : "", collate ? " DEFAULT COLLATE=" + collate : "");
        },
        ...
        __indexDefinitionSql : function(tableName, index) {
            ...
            var indexType = t == "fullText" ? "FULLTEXT " : t == "spatial" ? "SPATIAL " : index.unique ? "UNIQUE " : "";
            using = t != null ? " USING" + indexType : "";
        ...
        schemaAutoincrementingPrimaryKey : function(schema) {
            return this.super(arguments) && schema.dbType.match(/int/i);
        },
        ...
        schemaColumnType : function(dbType) {
            return this.static.convertTinyintToBool && dbType == 'tinyint(1)' ? "boolean" : this.super(arguments);
        },
    ...
    static : {
        ...
        convertMysqlType : function(type) {
            var convert = this.convertTinyintToBool;
...
}).export(exports, "MySQLDatabase");
DB.setAdapterType("mysql");