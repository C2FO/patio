...
var gender = ["M", "F"];
it.describe("patio.Model manyToMany hashKey properties", function (it) {

    var Company, Employee;
    it.beforeAll(function () {
        Company = patio.addModel("company").manyToMany("employees", {key: {companyId: "employeeId"}});
        Employee = patio.addModel("employee").manyToMany("companies", {key: {employeeId: "companyId"}});
