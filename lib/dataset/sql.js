...
comb.define(null, {
    ...
    static:{
         ...
         */
        DELETE_CLAUSE_METHODS:clauseMethods("delete", "from where"),
        /**
         ...
         */
        SELECT_CLAUSE_METHODS:clauseMethods("select", "with distinct columns from join where group having compounds order limit lock"),
        /**
