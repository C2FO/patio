...
comb.define(null, {
    ...
    instance:{
        ...
        truncateSql:function () {
            if (this.__opts.sql) {
                return this.staticSql(this.__opts.sql);
            } else {
                this.checkModificationAllowed();
...
//SQL fragment specifying the columns to insert into
        ...
        columnList:function (columns) {
            return (!columns || columns.length == 0) ? this._static.WILDCARD : this.expressionList(columns);
        },
        ...
        defaultTimestampFormat:function () {
            return this.requiresSqlStandardDateTimes ? this._static.STANDARD_TIMESTAMP_FORMAT : this._static.TIMESTAMP_FORMAT;
        },
        ...
        identifierList:function (columns) {
            return columns.map(this.quotedIdentifier, this).join(this._static.COMMA_SEPARATOR);
        },
        ...
        literalYear:function (o) {
            return comb.date.format(this._static.YEAR_FORMAT, o.date);
        },
