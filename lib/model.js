...
exports.create = function (name, supers, modelOptions) {
    ...
    if (!(model = MODELS.get(key)[checkAndTransformName(tableName.toString())])) {
        ...
        MODELS.get(key)[tableName] = model;
    }
    return model;
};
...
exports.syncModels = function (cb) {
    ...
    comb.serial(MODELS.entrySet.map(function (entry) {
        return function () {
            ...
            return comb.serial(Object.keys(value).map(function (m) {
                return hitch(value[m], "sync");
            }));
        };
