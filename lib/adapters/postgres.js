...
const asyncArray = comb.async.array;
...
const isDefined = comb.isDefined;
const isInstanceOf = comb.isInstanceOf;
const QueryError = require("../errors").QueryError;
const Dataset = require("../dataset");
const Database = require("../database");
const sql = require("../sql").sql;
const stringToIdentifier = sql.stringToIdentifier;
const DateTime = sql.DateTime;
const Time = sql.Time;
const Year = sql.Year;
...
const pipeAll = require("../utils").pipeAll;
const hashPick = comb.hash.pick;
const isSafeInteger = Number.isSafeInteger || require('is-safe-integer');
let patio, DS;
