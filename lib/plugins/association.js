...
exports.AssociationPlugin = comb.define(null, {
    ...
    static:{
         ...
         * One to Many often describes a parent child relationship, where the One To many Model is the parent,
         * and the many to one model is the child.
         *
         ...
         * </pre>
         * <p>
         *     You could set up your associations as follows:
         * </p>
         * <pre class="code">
         * comb.executeInOrder(patio, function(patio){
         *      //define the biological father model
         *      patio.addModel("biological_father", {
         *          static : {
         *              init : function(){
         ...
         * </pre>
         * <p>
         *     The models set up above are "LAZY" loaded meaning the associations are not loaded until the association
         *     is accessed. You can query each model by:
         * </p>
         * <pre class="code">
         * Child.findById(1).then(function(child){
         *     child.father.then(function(father){
         *          //father.name === "fred"
         *     });
         * });
         *
