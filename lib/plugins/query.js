        ...
        update:function(vals, options){
            if (!this.__isNew && this.__isChanged) {
                return this._checkTransaction(options, comb.hitch(this, function(){
                    ...
                    if (saveChanged) {
                        return comb.executeInOrder(this, function(m){
                            m._hook("pre", "update");
                            m._update();
                            m._hook("post", "update");
                            return m;
        ...
        save:function(vals, options){
            if (this.__isNew) {
                return this._checkTransaction(options, comb.hitch(this, function(){
                    ...
                    var ret = new comb.Promise();
                    this._hook("pre", "save")
                        .chain(comb.hitch(this, "_save"), comb.hitch(ret, "errback"))
                        .chain(comb.hitch(this, "_hook", "post", "save", null), comb.hitch(ret, "errback"))
                        .then(comb.hitch(ret, "callback", this), comb.hitch(ret, "errback"));
                }));
            } else {
