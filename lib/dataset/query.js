...
comb.define(null, {
    ...
    instance:{
        ...
        /**
         * Adds a futher filter to an existing filter using AND. This method is identical to {@link moose.Dataset#filter}
         * except it expects an existing filter.
         *
         * <p>
         *     <b>For parameter types see {@link moose.Dataset#filter}.</b>
         * </p>
         *
         * @example
         ...
         *
         * @throws {moose.QueryError} If no WHERE?HAVING clause exists.
         *
         * @return {moose.Dataset} a cloned dataset with the condtion added to the WHERE/HAVING clause added.
         */
        and:function () {
         ...
         *
         * @throws {moose.QueryError}  If arguments are given and DISTINCT ON is not supported.
         * @param {...String|...moose.sql.Identifier} args variable number of arguments used to create
         *                                                 the DISTINCT ON clause.
         * @return {moose.Dataset} a cloned dataset with the DISTINCT/DISTINCT ON clause added.
         */
         ...
         *
         * @throws {moose.QueryError} if the operation is not supported.
         * @param {moose.Dataset} dataset the dataset to use to create the EXCEPT clause.
         * @param {Object} [opts] options to use when creating the EXCEPT clause
         * @param {String|moose.sql.Identifier} [opt.alias] Use the given value as the {@link moose.Dataset#fromSelf} alias.
         * @param {Boolean} [opts.all] Set to true to use EXCEPT ALL instead of EXCEPT, so duplicate rows can occur
         * @param {Boolean} [opts.fromSelf] Set to false to not wrap the returned dataset in a {@link moose.Dataset#fromSelf}, use with care.
         *
         * @return {moose.Dataset} a cloned dataset with the EXCEPT clause added.
         */
        ...
        /**
         * Performs the inverse of {@link moose.Dataset#filter}.  Note that if you have multiple filter
         * conditions, this is not the same as a negation of all conditions. For argument types see
         * {@link moose.Dataset#filter}
         *
         * @example
         *
         ...
         * @return {moose.Dataset} a cloned dataset with the excluded conditions applied to the HAVING/WHERE clause.
         */
        exclude:function () {
        ...
        /**
         * Returns a copy of the dataset with the given conditions given applied to it.
         ...
         *
         *
         * @param {Object|Array|String|moose.sql.Identifier|moose.sql.BooleanExpression} args filters to apply to the
         ...
         *      <li>{@link moose.sql.Identifier} - taken as a boolean column argument (e.g. WHERE active)</li>
         *      <li>{@link moose.sql.BooleanExpression - an existing condition expression,
         ...
         * types, and is treated the same way.  This block is called with an {@link moose.sql} object which can be used to dynaically create expression.  For more details
         * on the sql object see {@link moose.sql}
         *
         * <p>
         *     <b>NOTE:</b>If both a cb and regular arguments are provided, they get ANDed together.
         * </p>
         *
         * @return {moose.Dataset} a cloned dataset with the filter arumgents applied to the WHERE/HAVING clause.
         **/
         ...
         * @return {moose.Dataset} a cloned dataset with a "update" lock style.
         */
        forUpdate:function () {
         ...
         *
         * @param {...String|...moose.sql.Identifier|...moose.Dataset|...Object} [source] tables to select from
         *
         * @return {moose.Dataset} a cloned dataset with the FROM clause overridden.
         */
         ...
         * @param {String|moose.sql.Identifier} [opts.alias] alias to use
         *
         * @return {moose.Dataset} a cloned dataset with the FROM clause set as the current dataset.
         */
         ...
         *
         * @param {String[]|moose.sql.Identifier[]} columns columns to search
         ...
         * @return {moose.Dataset} a dataset with the LIKE clauses added
         */
         ...
         * @param {String...|moose.sql.Identifier...} columns columns to group by.
         *
         * @return {moose.Dataset} a cloned dataset with the GROUP BY clause added.
         **/
         ...
         *      //=> [{name : 'a', count:1}, ...]
         * @param {String...|moose.sql.Identifier...} columns columns to croup and count on.
         *
         * @return {moose.Dataset} a cloned dataset with the GROUP clause and count added.
         */
        ...
        /**
         * Returns a copy of the dataset with the HAVING conditions changed. See {@link moose.Dataset#filter} for argument types.
         *
         * @example
         * DB.from("items").group("sum").having({sum : 10}).sql;
         *      //=> SELECT * FROM items GROUP BY sum HAVING (sum = 10)
         *
         * @return {moose.Dataset} a cloned dataset with HAVING clause changed or added.
         **/
        having:function () {
         ...
         *
         * @throws {moose.QueryError} if the operation is not supported.
         * @param  {moose.Dataset} dataset the dataset to intersect
         * @param  {Object} [opts] options
         * @param {String|moose.sql.Identifier} [opts.alias] Use the given value as the {@link moose.Dataset#fromSelf} alias
         * @param {Boolean} [opts.all] Set to true to use INTERSECT ALL instead of INTERSECT, so duplicate rows can occur
         * @param {Boolean} [opts.fromSelf] Set to false to not wrap the returned dataset in a {@link moose.Dataset#fromSelf}.
         *
         * @return {moose.Dataset} a cloned dataset with the INTERSECT clause.
         **/
         ...
         *      //=> SELECT * FROM items WHERE ((category != 'software') OR (id != 3))
         *
         * @return {moose.Dataset} a cloned dataset with the filter inverted.
         **/
        invert:function () {
         ...
         * @param {String|moose.sql.Identifier|moose.Dataset|Object} table depends on the type.
         *  <ul>
         *      <li>{@link moose.Dataset} - a subselect is performed with an alias</li>
         *      <li>Object - an object that has a tableName property.</li>
         *      <li>String|{@link moose.sql.Identifier}  - the name of the table</li>
         *  </ul>
         ...
         *     <li>Array - If all members of the array are string or {@link moose.sql.Identifier}, considers
         ...
         *     <li>Everything else - pretty much the same as a using the argument in a call to {@link moose.Dataset#filter},
         ...
         * @param {String|moose.sql.Identifier} [options.tableAlias=undefined] the name of the table's alias when joining, necessary for joining
         *     to the same table more than once.  No alias is used by default.
         * @param {String|moose.sql.Identifier} [options.implicitQualifier=undefined] The name to use for qualifying implicit conditions.  By default,
         ...
         *
         * @return {moose.Dataset} a cloned dataset joined using the arguments.
         */
         ...
         * @param {Number|String|moose.sql.LiteralString} offset the offset to apply
         *
         * @return {moose.Dataset}  a cloned dataset witht the LIMIT and OFFSET applied.
         **/
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the not equal expression added to the WHERE clause.
         */
        neq:function (obj) {
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the equal expression added to the WHERE clause.
         */
        eq:function (obj) {
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the greater than expression added to the WHERE clause.
         */
        gt:function (obj) {
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the less than expression added to the WHERE clause.
         */
        lt:function (obj) {
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the IS NOT expression added to the WHERE clause.
         *
         */
        isNot:function (obj) {
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the IS expression added to the WHERE clause.
         *
         */
        is:function (obj) {
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the IS NOT NULL expression added to the WHERE clause.
         *
         */
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the IS NULL expression added to the WHERE clause.
         *
         */
        isNull:function (arr) {
            arr = this.__arrayToConditionSpecifier(comb.argsToArray(arguments), null);
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the IS NOT TRUE expression added to the WHERE clause.
         *
         */
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the IS TRUE expression added to the WHERE clause.
         *
         */
        isTrue:function (arr) {
            arr = this.__arrayToConditionSpecifier(comb.argsToArray(arguments), true);
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the IS NOT FALSE expression added to the WHERE clause.
         *
         */
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the IS FALSE expression added to the WHERE clause.
         *
         */
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the greater than or equal to expression added to the WHERE clause.
         */
        gte:function (arr) {
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the less than or equal to expression added to the WHERE clause.
         */
        lte:function (obj) {
         ...
         *
         * @return {moose.Dataset} a cloned dataset with a between clause added
         * to the where clause.
         */
         ...
         *
         * @return {moose.Dataset} a cloned dataset with a not between clause added
         * to the where clause.
         */
         ...
         *
         * @return {moose.Dataset} a cloned datase with the given lock style.
         **/
         ...
         *          //=>SELECT * FROM items
         *  @params arg variable number of arguments similar to {@link moose.Dataset#filter}
         *
         *  @return {moose.Dataset} a cloned dataset with the order changed.
         * */
        order:function (args) {
            args = comb.argsToArray(arguments);
            var order = [];
        ...
        /**
         * Qualify to the given table, or {@link moose.Dataset#firstSourceAlias} if not table is given.
         *
         * @example
         ...
         *
         * @param {String|moose.sql.Identifier} [table={@link moose.Dataset#firstSourceAlias}] the table name to qualify to.
         *
         * @return {moose.Dataset} a cloned dataset qualified to the table or @link moose.Dataset#firstSourceAlias}
         **/
         ...
         * See {@link moose.Dataset#qualifyTo}
         *
         * @example
         *
         ...
         *      //=> SELECT items.* FROM items WHERE (items.id = 1)
         *
         * @return {moose.Dataset} a cloned dataset that is qualified with the first source.
         * */
         ...
         *
         * @return {moose.Dataset} a cloned dataset with unqualified identifiers qualified.
         */
         ...
         *
         * @param {String|moose.sql.Identifier|Function} args variable number of columns add to order before reversing.
         *
         * @return {moose.Dataset} a cloned dataset with the order reversed.
         *
         **/
         ...
         * to the given columns. This also takes a function similar to {@link moose.Dataset#filter}
         *
         * @example
         ...
         *
         *  @param {String|moose.sql.Identifier|Function} args variable number of colums to select
         *  @return {moose.Dataset} a cloned dataset with the columns selected changed.
         */
         ...
         *
         * @return {moose.Dataset}  a cloned dataset that selects *.
         */
        selectAll:function () {
         ...
         *
         * @return {moose.Dataset} returns a cloned dataset with the new select columns appended.
         */
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the defaults added to the current datasets defaults.
         */
         ...
         * @param {Object} hash object with key value pairs to use as override values
         *
         * @return {moose.Dataset} a cloned dataset with the overrides added to the current datasets overrides.
         */
         ...
         *
         * @return {moose.Dataset} a cloned dataset with no HAVING or WHERE clause.
         */
        unfiltered:function () {
         ...
         *
         * @return {moose.Dataset} a cloned dataset with no GROUP or HAVING clause.
         */
        ungrouped:function () {
         ...
         *
         * @param {moose.Dataset} dataset dataset to union with
         * @param {Object} opts addional options
         * @param {String|moose.sql.Identifier} [opts.alias] Alias to use as the fromSelf alias.
         ...
         *
         * @return {moose.Dataset} a cloned dataset with the union.
         *
         */
         ...
         *      //=> SELECT * FROM t
         *
         * @return {moose.Dataset} a cloned dataset with no limit or offset.
         */
        unlimited:function () {
         ...
         *      //=> SELECT * FROM t
         *
         * @return {moose.Dataset} a cloned dataset with no order.
         */
        unordered:function () {
        ...
        /**
         * Add a condition to the WHERE clause.  See {@link moose.Dataset#filter} for argument types.
         *
         * @example
         ...
         * @param {moose.Dataset} nonRecursive the non-recursive part of the CTE
         * @param {moose.Dataset} recursive the recursive part of the CTE
         * @param {Object} [opts={}] extra options
         ...
         * to keep the same {@link moose.Dataset#rowCb}/{@link moose.Dataset#graph},
         *  but change the SQL used to custom SQL.
         *
         * @example
         *  DB.from("items").withSql('SELECT * FROM foo') # SELECT * FROM foo
         *
         *  @param {String} sql sql for the dataset to use.
         *
         *  @return {moose.Dataset} a cloned dataset with the static sql set.
         */
         ...
         * @param {moose.Dataset} dataset the dataset to add to
         * @param [Object] [options={}] compound option to use (i.e {all : true})
         *
         * @return {moose.Dataset} ds with the dataset added to the compounds.
         */
        ...
        /**
         * Returns the a cloned dataset with out the {@link moose.Dataset#rowCb}
         *
         * @example
         * var ds = DB.from("test");
         * ds.rowCb = function(r){
         ...
         * });
         *
         * @return {moose.Dataset} a cloned dataset with out the {@link moose.Dataset#rowCb}
         */
        naked:function () {
        ...
        /**
         * Splits a possible implicit alias, handling both {@link moose.sql.AliasedExpression}s
         ...
         *
         * @return {moose.sql.BooleanExpression} boolean expression joined by a AND of each key value pair compared by the op
         */
         ...
         *
         * @return {moose.sql.BooleanExpression} a boolean expression containing the between expression.
         */
         ...
         * @param {String[]|moose.sql.Identifier} arr array of elements to make a condition specifier out of
        ...
        __arrayToConditionSpecifier:function (arr, defaultOp) {
            ...
            arr.forEach(function (a) {
                if (comb.isString(a)) a = this.stringToIdentifier(a);
         ...
         * @private
         *
         * SQL expression object based on the expr type.  See {@link moose.Dataset#filter}
         */
         ...
         *
         * @return {moose.sql.Expression} an expression to use in the filter
         */
        __filterObject:function (expr, key) {
            var pairs = [], opts, newKey;
            var twoArityOperators = this._static.TWO_ARITY_OPERATORS;
            for (var k in expr) {
                var v = expr[k];
                if (comb.isHash(v)) { //its a hash too filter it too!
                    ...
                    if (newKey.length > 1) {
                        ...
                        if (k.match(/^like$/)) {
                            ...
                            pairs.push(this.__createBoolExpression(k, [
                                [newKey[0], expr[k]]
                            ]));
                        }
                    }
                    ...
                    newKey = k.split(",");
                    if (newKey.length == 1) {
                        newKey = new Identifier(newKey[0]);
                    }
                    opts = [
                        [newKey, v]
                    ];
    ...
    static:{
        ...
        /**
         * These symbols have {name}Join methods created (e.g. {@link moose.Dataset#innerJoin}) that
         * call {@link moose.Dataset#joinTable} with the string, passing along the arguments and
         ...
         * call {@link moose.Dataset#joinTable} with the symbol.  They only accept a single table
         * argument which is passed to {@link moose.Dataset#joinTable}, and they raise an error
        ...
        /**
         * Which options don't affect the SQL generation.  Used by {@link moose.Dataset#simpleSelectAll}
        ...
        QUERY_METHODS:['addGraphAliases', "and", "distinct", "except", "exclude", "filter", "find", "is", "isNot",
            ...
            "orderAppend", "orderBy", "orderMore", "orderPrepend", "paginate", "qualify", "query", "reverse",
            "reverseOrder", "select", "selectAll", "select_append", "selectMore", "server", "setDefaults",
