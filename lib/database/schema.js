...
define(null, {
    instance:{
        ...
        addIndex:function (table, columns, options) {
            ...
            var ret = new Promise();
            this.alterTable(table,function () {
        ...
        alterTable:function (name, generator, block) {
            ...
            return this.__alterTableSqlList(name, generator.operations).chain(function (res) {
                return asyncArray(comb(res).pluck("1").flatten()).forEach(function (sql) {
                    return this.executeDdl(sql);
                }, this).chain(comb("removeCachedSchema").bindIgnore(this, name));
            }.bind(this));
        },
        ...
        createTable:function (name, options, block) {
            ...
            return this.__createTableFromGenerator(name, generator, options)
                .chain(comb("__createTableIndexesFromGenerator").bindIgnore(this, name, generator, options));
        },
        ...
        forceCreateTable:function (name, options, block) {
            return this.dropTable(name).chainBoth(comb("createTable").bindIgnore(this, name, options, block));
        },
        ...
        createTableUnlessExists:function (name, options, block) {
            ...
            return this.tableExists(name).chain(function (exists) {
                if (!exists) {
                    return this.createTable(name, options, block);
                }
            }.bind(this));
        },
        ...
        createOrReplaceView:function (name, source) {
            ...
            return this.executeDdl(format("CREATE OR REPLACE VIEW %s AS %s", this.__quoteSchemaTable(name), source)).chain(function () {
                this.removeCachedSchema(name);
            }.bind(this));
        },
        ...
        dropTable:function (names) {
            ...
            return serial(names.filter(function (t) {
                return isString(t) || isInstanceOf(t, Identifier, QualifiedIdentifier);
            }).map(function (name) {
                return function () {
                    return this.executeDdl(this.__dropTableSql(name)).chain(function () {
                        return this.removeCachedSchema(name);
                    }.bind(this));
                }.bind(this);
            }.bind(this)));
        },
        ...
        renameTable:function (name, newName) {
            return this.executeDdl(this.__renameTableSql(name, newName)).chain(hitch(this, function () {
                this.removeCachedSchema(name);
            })).promise();
        ...
        __createTableIndexesFromGenerator:function (name, generator, options) {
            ...
            if (promises.length) {
                new PromiseList(promises).then(ret, hitch(ret, e ? "callback" : "errback"));
            } else {
                ret.callback();
            }
            return ret.promise();
