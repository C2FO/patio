...
//        },
    ...
    "static":{
        ...
        BOOL_TRUE:'true',
        COMMA_SEPARATOR:', ',
        DELETE_CLAUSE_METHODS:Dataset.clauseMethods("delete", 'with from using where'),
        EXCLUSIVE:'EXCLUSIVE',
        EXPLAIN:'EXPLAIN ',
        EXPLAIN_ANALYZE:'EXPLAIN ANALYZE ',
        FOR_SHARE:' FOR SHARE',
        INSERT_CLAUSE_METHODS:Dataset.clauseMethods("insert", 'with into columns values'),
        ...
        UPDATE_CLAUSE_METHODS:Dataset.clauseMethods("update", 'with update table set from where'),
        XOR_OP:' # ',
        CRLF:"\r\n",
