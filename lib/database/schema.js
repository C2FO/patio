...
var Database = comb.define(null, {
    instance : {
        ...
        __columnDefinitionSql : function(column) {
            ...
            column.unique && (sql += this.static.UNIQUE);
            (column.allowNull === false || column.null == false) && (sql += this.static.NOT_NULL);
            (column.allowNull === true || column.null == true) && (sql += this.static.NULL);
            !comb.isUndefined(column["default"]) && (sql += format("DEFAULT %s", this.literal(column["default"])));
            column.primaryKey && (sql += this.static.PRIMARY_KEY);
        ...
        __columnListSql : function(generator) {
            return generator.columns.map(hitch(this, "__columnDefinitionSql")).concat(generator.constraints.map(hitch(this, "__constraintDefinitionSql"))).join(this.static.COMMA_SEPARATOR);
        },
        ...
        __columnReferencesSql : function(column) {
            ...
            column.key && (sql += format("(%s)", array.toArray(column.key).map(this.__quoteIdentifier, this).join(this.static.COMMA_SEPARATOR)));
        ...
        __defaultIndexName : function(tableName, columns) {
            ...
            index.push("index");
            return index.join(this.static.UNDERSCORE);
        ...
        __onDeleteClause : function(action) {
            return this.static[action.toUpperCase()] || this.static.NO_ACTION;
        },
        ...
        __typeLiteralGeneric : function(column) {
            ...
            if (type === String || type.match(/string/i)) {
                meth += "String";
            } else if (type === Number || type.match(/number/i)) {
                meth += "Numeric";
            } else if (type == Date || type.match(/date/i)) {
                meth += "Date";
            } else if (type == Boolean || type.match(/boolean/i)) {
                meth += "Boolean";
            } else {
        ...
        __typeLiteralGenericDate : function(column) {
            return column.onlyTime ? "time" : column.timeStamp ? "timestamp" : column.dateTime ? "datetime" : "date";
        },
        ...
        getters : {
            ...
            autoIncrementSql : function() {
                return this.static.AUTOINCREMENT;
            },

            temporaryTableSql : function() {
                return this.static.TEMPORARY;
            },
