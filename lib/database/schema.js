    ...
    instance:{
        ...
        alterTable:function (name, generator, block) {
            ...
            this.__alterTableSqlList(name, generator.operations).then(hitch(this, function (res) {
                ...
                var drop = hitch(this, function (i) {
                    if (i < l) {
                        var sql = sqls[i++];
                        this.executeDdl(sql).then(hitch(this, drop, i), ret);
                    } else {
        ...
        createTable:function (name, options, block) {
            ...
            return this.__createTableFromGenerator(name, generator, options)
                .chain(hitch(this, "__createTableIndexesFromGenerator", name, generator, options))
                .promise();
        },
        ...
        forceCreateTable:function (name, options, block) {
            return this.dropTable(name)
                .chainBoth(hitch(this, this.createTable, name, options, block))
                .promise();
        },
        ...
        createTableUnlessExists:function (name, options, block) {
            ...
            this.tableExists(name).then(hitch(this, function (exists) {
                if (!exists) {
                    this.createTable(name, options, block).then(ret);
                } else {
                    ret.callback();
                }
            }), ret);
         ...
         *      //=>'DROP TABLE ccc'
         *
         * @param {String|String[]|essom.sql.Identifier|essom.sql.Identifier[]} names the names of the tables
         * to drop.
         *
         ...
         *
         * @param {String|String[]|essom.sql.Identifier|essom.sql.Identifier[]} names the names of the views
         * to drop.
         *
