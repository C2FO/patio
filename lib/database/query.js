    ...
    instance: {
        ...
        transaction: function (opts, cb) {
            ...
            if (this.__alreadyInTransaction) {
                return this.__enqueueTransaction(opts, cb);
            } else {
        ...
        __transactionProxy: function (conn, opts, cb) {
            var promises = [];
            var repl = [];
                        ...
                        if (n === "execute") {
                            ...
                            if (isFunction(arg1)) {
                                ...
                                if (this.supportsSavepoints && !isUndefinedOrNull(arg1.savepoint)) {
                                    ...
                                    ret = this.__enqueueTransaction(opts, arg2);
                                }
                            }
                        }
                    } catch (e) {
            ...
            try {
                ...
                var cbRet = cb.apply(this, [this, hitch(transactionP, transactionP.resolve)]);
            ...
            try {
                ...
                return this.__getTransactionConnection(conn).chain(function (conn) {
                    return self.__beginTransaction(conn, opts).chain(function () {
                        return self.__transactionProxy(conn, opts, cb)
                            .chain(function () {
